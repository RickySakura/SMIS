...
<div class="container">
    ...
    <p><a href="/querymenu.jsp">按条件查询</a></p>
                    ...
                    <td width="120px" style="text-align: center">
                        <c:choose>
                            <c:when test="${s.status eq '未完成'}">
                                <form action="/editStatus" method="post"name="form1" style="width: 144px;"><button type="submit" style="float: left;width: 90px">去完成</button>
